...
@Getter
public class Log extends MetaMapper {
    ...
    public int getMeta(NbtMap originalState) {
        return material.getOrDefault(originalState.getString("old_log_type"), 0)
                + material.getOrDefault(originalState.getString("new_log_type"), 0)
