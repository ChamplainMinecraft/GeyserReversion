...
@Getter
public class StoneBlock extends MetaMapper {
    ...
    private final Map<String, Integer> material = new HashMap<>() {{
        put("stone", 0);
        put("granite", 1);
        put("granite_smooth", 2);
        put("diorite", 3);
        put("diorite_smooth", 4);
        put("andesite", 5);
        put("andesite_smooth", 6);
    }};

    @Override
    public int getMeta(NbtMap originalState) {
        return material.get(originalState.getString("stone_type"));
    }
