...
package au.com.grieve.geyser.reversion.versions.mcee.utils;
...
public class TokenManager {
    ...
    public TokenManager(GeyserPlugin plugin) {
        this.plugin = plugin;
    ...
    void load() {
        ...
        try (InputStream input = new FileInputStream(new File(plugin.getDataFolder(), TOKENS_FILE))) {
    ...
    void save() {
        ...
        try (FileWriter output = new FileWriter(new File(plugin.getDataFolder(), TOKENS_FILE))) {
    ...
    public URL getNewAuthorizationUrl() {
        try {
            return new URL("https://login.microsoftonline.com/common/oauth2/authorize" +
                    ...
                    "&resource=" + URLEncoder.encode("https://meeservices.minecraft.net", StandardCharsets.UTF_8));
